...
3. MFApp (This is micro frontends host application and will run on port 300).
...
4. You will see components from both the child applicationsare used in host application.
